...
//i want if a selected weekly and selected days and locations and when i click monthly then these days should also be there as we selected for weekly. if i dont select weekly that means we have option to select as per our requirement, 1 supervisor has only one plan. i want to give supervisor list edit option in which admin have right to edit assigned journey plan. and one supervsior has only one plan. 